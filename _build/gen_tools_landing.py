...
CATEGORIES = [
    ...
    ('R Output Interpreters', ['lm-output-interpreter','glm-output-interpreter','lmer-output-interpreter','anova-output-interpreter','diagnostic-plot-interpreter','vif-interpreter','confusion-matrix-interpreter']),
