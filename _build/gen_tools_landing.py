...
CATEGORIES = [
    ...
    ('R Output Interpreters', ['lm-output-interpreter','glm-output-interpreter','lmer-output-interpreter','coxph-output-interpreter','bayesian-output-interpreter','anova-output-interpreter','diagnostic-plot','vif-interpreter','confusion-matrix-interpreter']),
    ('Pickers and Decision Tools', ['statistical-test-chooser','normality-test-picker','nonparametric','dag-confounder-picker']),
    ...
    ('Specialized', ['ts-stationarity-calculator','acf-pacf-calculator','outlier-detection-calculator','roc-auc-calculator','cronbachs-alpha-calculator','cohens-kappa-calculator','icc-calculator','meta-analysis-quick-tool','reprex-builder']),
]
...
C3META = {
 ...
 'lmer-output-interpreter': ('lmer() Interpreter', 'lmer',
  'Paste summary(lmer(...)). Variance components, the ICC with its formula, and where the p-values went.',
  '<path class="s" d="M7 5 V38 H40"/><path class="a" d="M10 30 L37 14" fill="none"/><path class="a" style="opacity:.55" d="M10 24 L37 8" fill="none"/><path class="a" style="opacity:.55" d="M10 36 L37 20" fill="none"/><circle class="af" cx="16" cy="26.4" r="1.9"/><circle class="af" cx="28" cy="19.3" r="1.9"/><circle class="af" cx="16" cy="20.4" r="1.9"/><circle class="af" cx="28" cy="13.3" r="1.9"/><circle class="af" cx="16" cy="32.4" r="1.9"/><circle class="af" cx="28" cy="25.3" r="1.9"/>'),
 'bayesian-output-interpreter': ('Bayesian Output', 'brms',
  'Paste summary() from brms or rstanarm. Credible intervals in plain English, Rhat and ESS decoded, and an honest verdict on whether the fit converged.',
  '<path class="s" d="M4 37 H40"/><path class="af" d="M8 30 C16 30 17 8 22 8 C27 8 28 30 36 30 Z" style="opacity:.2"/><path class="a" d="M8 30 C16 30 17 8 22 8 C27 8 28 30 36 30" fill="none"/><path class="s" d="M12 36 H32"/><circle class="af" cx="22" cy="36" r="2.2"/>'),
 'coxph-output-interpreter': ('coxph() Interpreter', 'coxph',
  'Paste summary(coxph(...)). Hazard ratios in plain English, the concordance, and the assumption the printout never checks.',
  '<path class="s" d="M7 5 V38 H40"/><path class="a" d="M9 9 H16 V17 H23 V25 H31 V33 H39" fill="none"/><path class="s" style="opacity:.5" d="M19.5 13.5 V20.5 M27 21.5 V28.5"/><circle class="af" cx="16" cy="17" r="1.9"/><circle class="af" cx="23" cy="25" r="1.9"/><circle class="af" cx="31" cy="33" r="1.9"/>'),
 ...
 'diagnostic-plot': ('Diagnostic Plots', 'resid',
 ...
 'nonparametric': ('Nonparametric Tests', 'ranks',
 ...
 'prediction-interval-calculator': ('Prediction Interval', 'predict()',
  ...
  '<path class="s" d="M8 5 V38 H41"/><path class="a" d="M10 33 L39 12" fill="none"/><path class="s" d="M10 38Q24.5 20 39 5" fill="none" stroke-dasharray="2.5 2"/><path class="s" d="M10 28Q24.5 22 39 19" fill="none" stroke-dasharray="2.5 2"/><circle class="af" cx="24.5" cy="22.5" r="2.4"/>'),
 ...
 'post-hoc-calculator': ('Post-Hoc Tests', 'HSD',
  ...
  '<path class="s" d="M6 38 H40"/><circle class="af" cx="12" cy="30" r="2.4"/><circle class="af" cx="23" cy="22" r="2.4"/><circle class="af" cx="34" cy="12" r="2.4"/><path class="a" d="M12 30 V26 M23 22 V26 M12 26 H23" fill="none"/><path class="a" d="M23 22 V17 M34 12 V17 M23 17 H34" fill="none"/><path class="s" d="M12 34 V37 M34 34 V37 M12 37 H34" stroke-dasharray="2 2"/>'),
