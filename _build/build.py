...
_TOOL_ICONS = {
    ...
    'sample-size-anova-calculator.html':   # three group columns of differing height
        '<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">'
        '<path d="M2.5 2.5v11h11"/>'
        '<path d="M5.5 13.5V10"/>'
        '<path d="M9 13.5V6"/>'
        '<path d="M12.5 13.5V8"/></svg>',
    'z-score-percentile.html':
        '<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">'
        '<path d="M2 13c2 0 3-1 4-3s1.5-6 2-6 .5 6 2 6 2.5 0 4 0"/>'
        '<path d="M2 13.5h12"/></svg>',
    'normal-distribution-calculator.html':   # bell curve with a shaded central area
        '<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">'
    ...
    'bayesian-ab-test-calculator.html':   # two posterior humps, the leader filled
        '<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">'
        '<path d="M1.5 13.5h13"/>'
    ...
    'standard-deviation-calculator.html':   # bell curve with a sigma span underneath
        '<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">'
        '<path d="M1.5 11.5h13"/>'
        '<path d="M2 11.5C5 11.5 5.2 4 8 4C10.8 4 11 11.5 14 11.5"/>'
        '<path d="M5.5 14h5"/><path d="M5.5 13v2"/><path d="M10.5 13v2"/></svg>',
    ...
    'glm-output-interpreter.html':
        ...
        '<path d="M2 13.5h12"/></svg>',
    # lmer: parallel per-group lines (the random-intercept picture)
    'lmer-output-interpreter.html':
        '<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">'
        '<path d="M2 13.5V2.5"/>'
        '<path d="M2 13.5h12"/>'
    ...
    'pearson-critical-values-table.html':   # table grid with a rising fit line inside
        '<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">'
        '<rect x="2.5" y="3" width="11" height="10" rx="1"/>'
        '<path d="M2.5 6.5h11M6 3v10"/>'
        '<path d="M7.2 11.8 12.4 8.2"/>'
        '<circle cx="7.8" cy="11.2" r=".8" fill="currentColor" stroke="none"/>'
        '<circle cx="10" cy="10" r=".8" fill="currentColor" stroke="none"/>'
        '<circle cx="12" cy="8.6" r=".8" fill="currentColor" stroke="none"/></svg>',
    ...
    'icc-calculator.html':   # subjects as rows of rater dots, tightly clustered = agreement
        '<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">'
        '<path d="M2.5 2.5V13.5H13.5"/>'
        '<circle cx="5.6" cy="4.7" r="1" fill="currentColor" stroke="none"/>'
        '<circle cx="7.2" cy="4.7" r="1" fill="currentColor" stroke="none"/>'
        '<circle cx="6.4" cy="8" r="1" fill="currentColor" stroke="none"/>'
        '<circle cx="11" cy="8" r="1" fill="currentColor" stroke="none"/>'
        '<circle cx="10.2" cy="11.3" r="1" fill="currentColor" stroke="none"/>'
        '<circle cx="11.8" cy="11.3" r="1" fill="currentColor" stroke="none"/></svg>',
...
COMPENDIUM_TOOLS = [
    ...
    {'group': 'Reference tables', 'slug': 'pearson-critical-values-table.html',  'text': 'Pearson r Table'},
...
def patch_tool_pages(sections, asset_hrefs):
    ...
    def _refresh_cache_busts(html):
        ...
        new_html = re.sub(r'roadmap-nav\.js\?v=\d+', 'roadmap-nav.js?v=7', new_html)
        ...
        if 'roadmap-nav.js' not in new_html and 'practice-nav.js' in new_html:
            new_html = new_html.replace('<script defer src="/www/practice-nav.js?v=12"></script>',
                '<script defer src="/www/practice-nav.js?v=12"></script><script defer src="/www/roadmap-nav.js?v=7"></script>', 1)
        if 'practice-nav.js' not in new_html:
            new_html = re.sub(
                r'</body>',
                '<script defer src="/www/practice-nav.js?v=12"></script>'
                '<script defer src="/www/roadmap-nav.js?v=7"></script></body>',
        ...
        if 'site-nav.css' not in new_html:
            new_html = re.sub(
                r'</head>',
                '<link rel="stylesheet" href="/www/site-nav.css?v=10"></head>',
                new_html, count=1, flags=re.IGNORECASE,
            )
    ...
    for fname in sorted(os.listdir(tools_dir)):
        ...
        html = head_close_re.sub(layout_css + '<link rel="stylesheet" href="/www/site-nav.css?v=10">\n</head>', html, count=1)
        ...
        wrapper_close = (
            ...
            f'<script defer src="/www/roadmap-nav.js?v=7"></script>'
