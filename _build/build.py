...
WEBR_HEAD_BLOCK = """
    ...
    <style>
      ...
      .webr-runall-btn:hover { background: #2c5fbe; }
      .webr-runall-btn:disabled { background: #a5b4d4; cursor: wait; }
      .webr-runall-btn.running { background: #d29922; animation: pulse-run 1.5s ease-in-out infinite; }
