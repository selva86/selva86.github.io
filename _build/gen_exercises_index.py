...
.a3-demo{background:var(--card);border:1px solid var(--line);border-radius:0;padding:14px 16px 13px}
...
<section class="a2-wallwrap reveal" id="wall">
  ...
  {out(f"{TOT['hubs']} hubs &middot; {TOT['exercises']:,} problems &middot; <span id='wallSolved'>0</span> solved &middot; {TOT['xp']:,} XP")}
