...
<script defer src="/www/auth-hydrate.js?v=16"></script><script defer src="/www/practice-nav.js?v=6"></script><script defer src="/www/persona-menu.js?v=4"></script><script defer src="/www/google-onetap.js?v=2"></script><script defer src="/www/signin-nudge.js?v=11"></script><script defer src="/www/xp-chip.js?v=1"></script>'''
