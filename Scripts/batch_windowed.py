...
for the cover. No sentence of the email may reappear reworded anywhere in
the lesson, but its plain words are free to reuse.
...
3. It treats a model, a posterior or a test as a person: it believes,
   ...
   test says p = 0.03.)
4. It describes a model, a method, a dataset or a result with a word from
