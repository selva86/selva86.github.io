...
Today's let's understand interaction effect: the case where one variable's effect on an outcome depends on a second variable, rather than staying one fixed number.
