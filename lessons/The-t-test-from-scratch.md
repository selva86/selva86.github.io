...
catalog_blurb: "How to tell a real difference from random variation."
...
course_next: "Comparing-Groups-with-t-tests.html"
course_prev: ""
lesson_access: "free"
---
...
::widget null-distribution {"tails":2,"max":4,"start":3.3,"label":"a result out here would be surprising by chance"}
...
```r
t_stat <- -3.28; df <- 19
2 * pt(t_stat, df)      # times 2: over- and under-filling both count
#> [1] 0.0039
```
...
- [Student (1908), The Probable Error of a Mean, Biometrika](https://doi.org/10.2307/2331554) - the original paper that introduced the t-distribution.
- [OpenIntro Statistics (free textbook)](https://www.openintro.org/book/os/) - a clear, rigorous treatment of inference, the t-distribution and p-values.
- [R reference: t.test()](https://stat.ethz.ch/R-manual/R-devel/library/stats/html/t.test.html) - the official documentation for the function you just used.
