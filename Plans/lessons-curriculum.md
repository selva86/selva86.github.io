...
2. dplyr-vs-data-table - The same task in both, head to head, the speed and memory trade-offs, and bridging them with dtplyr. widgets: chart-plotter, table-transform
