...
(function (root) {
  ...
  var sections = {
    ...
    ds: [
      ...
      S(5,true,"The tidymodels workflow",'',["Preprocess data with recipes","Define models with parsnip (and bonsai for boosting)","Bundle steps with workflows","Resample with rsample","Measure with yardstick","Tune with the tune package","Compare many models with workflowsets"],"ML exercises","model lab",'core'),
      S(6,true,"Feature engineering and selection",'',["Encoding categorical variables","Target / impact encoding, done out-of-fold (leak-free)","Scaling and transformations","Interaction and spline features","Date, text and geospatial features","Missing data","Feature selection","Detecting target leakage"],"ML exercises","model lab",'core'),
      S(7,true,"Model evaluation, resampling and tuning",'',["Cross-validation strategies","Grouped, blocked and time-aware CV","Nested cross-validation, done right","Grid, random and Bayesian tuning","Faster search","Proper scoring rules and regression metrics","Comparing models statistically","From metrics to money"],"ML exercises","model lab",'core'),
      S(8,true,"Imbalanced, cost-sensitive and calibrated classification",'',["Beyond binary","Class imbalance with themis","Choosing the threshold under asymmetric costs","ROC, PR, lift and gains curves","Calibrating predicted probabilities","Why AUC is not enough"],"ML exercises","model lab",'core'),
      S(9,true,"Unsupervised - clustering and dimensionality reduction",'',["PCA in R","Factor analysis","k-means and choosing k","Hierarchical and density clustering","Gaussian mixture models with mclust","Cluster validation and stability","t-SNE and UMAP","Association rules and market-basket analysis"],"ML exercises","model lab",'core'),
      S(10,true,"Experiment and causal basics",'',["Correlation, causation and potential outcomes","Causal diagrams (DAGs) for your assumptions","A/B testing and experiment design","Reading an experiment","When you cannot randomize"],"ML exercises","model lab",'core'),
      S(11,true,"Interpretability and responsible AI (essentials)",'',["Global vs local explanations","Permutation and drop-column importance","SHAP values","Partial dependence, ICE and ALE plots","Fairness basics","Model cards and documenting a model"],"ML exercises","model lab",'core'),
      S(12,true,"Shipping your first model (production essentials)",'',["Reproducible pipelines with targets","Version and register a model with vetiver and pins","Serve a model with plumber","Batch vs real-time inference","Monitoring and drift","An ML system design checklist"],"ML exercises","model lab",'core'),
      S(13,false,"Regression and GLMs - the expert cut",'',["Robust regression I","Robust regression II","Quantile regression","Regularized regression, deep","GAMs done properly","Zero-inflated and hurdle models for counts (pscl)","Gamma, Tweedie and beta regression","Ordinal and multinomial regression (polr, VGAM)","Mixed / multilevel models"],"ML exercises","model lab",'adv'),
      S(14,false,"Advanced supervised learning",'',["Support vector machines and the kernel trick","Regularized discriminant analysis and shrinkage covariance","Gaussian processes for regression and uncertainty","Stacking and the Super Learner","Bayesian optimization for hyperparameters","Approximate nearest neighbors at scale"],"ML exercises","model lab",'adv'),
      S(15,false,"Survival and time-to-event",'',["Survival data and Kaplan-Meier","Cox proportional hazards","Parametric and accelerated failure time (AFT) models (flexsurv)","Competing risks and cumulative incidence (Fine-Gray)","Survival machine learning","Evaluating survival models"],"ML exercises","model lab",'adv'),
      S(16,false,"Bayesian and hierarchical modeling",'',["The Bayesian update","MCMC in practice with brms / rstanarm","Hierarchical / multilevel models and partial pooling","Posterior predictive checks and the Bayesian workflow","Model comparison","Bayesian regression and GLMs"],"ML exercises","model lab",'adv'),
      S(17,false,"Experimentation and online learning",'',["Designing for power","Variance reduction","Pitfalls","Cluster and switchback experiments","Multi-armed bandits","Contextual bandits and off-policy evaluation"],"ML exercises","model lab",'adv'),
      ...
      S(19,false,"Robustness, drift and distribution shift",'',["Kinds of shift","Detecting shift","Adapting","Out-of-distribution and novelty detection","Group robustness / DRO and worst-group accuracy","Adversarial robustness"],"ML exercises","model lab",'adv'),
      S(20,false,"Anomaly detection and advanced unsupervised",'',["Isolation forest and extended isolation forest (isotree)","Local outlier factor and one-class SVM","Autoencoders for anomalies","Time-series anomaly detection","Kernel PCA, sparse PCA and NMF","Self-supervised / contrastive representation"],"ML exercises","model lab",'adv'),
      S(21,false,"Uncertainty - conformal, calibration and probabilistic prediction",'',["Prediction intervals you can trust","Conformal prediction","Quantile and distributional regression for uncertainty","Calibration, deep","The bootstrap and the jackknife+"],"ML exercises","model lab",'adv'),
      S(22,false,"Explainability, fairness and privacy (deep)",'',["SHAP interactions and the H-statistic","LIME, anchors and counterfactual explanations (recourse)","Global surrogate and feature-interaction detection","Fairness","Differential privacy and membership-inference attacks","Governance"],"ML exercises","model lab",'adv'),
      S(23,false,"Natural language processing",'',["Text preprocessing and tokenization (tidytext)","Bag-of-words and TF-IDF","Topic modeling with LDA","Word and document embeddings","Named-entity recognition and sequence labeling","Text classification, end to end","Text similarity and dedup","Transformers and sentence embeddings","LLMs for extraction and classification (ellmer)"],"ML exercises","model lab",'spec'),
      S(24,false,"Deep learning",'',["Neural networks from the ground up","How training works","Optimization","Regularization","Deep learning in R with torch and luz","Convolutional networks for images","Sequence models, attention and transformers","Transfer learning and fine-tuning","Tabular deep learning"],"ML exercises","model lab",'spec'),
      S(25,false,"Recommenders, ranking and search",'',["Collaborative filtering and matrix factorization","Content-based and hybrid recommenders","Implicit feedback and the cold-start problem","Learning to rank","Two-tower retrieval and embeddings for search","Sequential / session-based recommendation","Off-policy evaluation and position bias (IPS)","Evaluating recommenders"],"ML exercises","model lab",'spec'),
      S(26,false,"LLMs and Generative AI (2026 frontier)",'',["Talk to an LLM from R with ellmer","Structured output and function / tool calling","Embeddings and vector search with duckdb","Retrieval-augmented generation (RAG)","Advanced RAG","Fine-tuning vs RAG vs prompting (LoRA / QLoRA)","Evaluating LLM systems and LLM-as-judge","Agents and tool use","Guardrails, cost and hallucination control"],"ML exercises","model lab",'spec'),
      S(27,false,"Graph and network ML",'',["Graph data and features (igraph / tidygraph)","Centrality and influence","Community detection","Node embeddings","Graph neural networks","Link prediction"],"ML exercises","model lab",'spec'),
      S(28,false,"Geospatial ML",'',["Spatial data and features (sf)","Spatial autocorrelation","Spatial cross-validation and spatial leakage (blockCV / CAST)","Kriging and Gaussian-process spatial models (gstat)","Geographically weighted regression"],"ML exercises","model lab",'spec'),
      S(29,false,"Data-centric AI",'',["Label noise and confident learning","Active learning","Weak supervision and programmatic labeling","Data valuation","Dataset shift and curriculum design"],"ML exercises","model lab",'spec')
    ],
    ts: [
    ...
    mleng: [
      S(1,true,"The ML engineering mindset and lifecycle",'',["What an ML Engineer does","The ML lifecycle and MLOps maturity","From notebook to a structured, packaged ML codebase","Environments, dependencies and reproducibility","The platform and the DS-to-MLE handoff"],"MLOps exercises","pipeline lab",'core'),
      S(2,true,"Reproducible pipelines and orchestration",'',["From a pile of scripts to a DAG","Build a pipeline with targets","Caching, invalidation and incremental runs","Parameterized and dynamically-branched pipelines","Scheduling and orchestration","Pipeline testing and debugging"],"MLOps exercises","pipeline lab",'core'),
      S(3,true,"Data and features for production",'',["Data validation and contracts with pointblank","Schema enforcement and data-quality gates in the pipeline","Data versioning and lineage","Feature pipelines that do not leak","Columnar and larger-than-memory data","Batch, incremental and change-data-capture ingestion"],"MLOps exercises","pipeline lab",'core'),
      S(4,true,"Model packaging, serialization and the registry",'',["Serializing models and objects","Bundling preprocessing with the model","Packaging ML code as an R package","Model versioning with vetiver","A model registry and promotion workflow","Model cards and metadata as first-class, queryable artifacts"],"MLOps exercises","pipeline lab",'core'),
      S(5,true,"Serving models - the serving discipline",'',["The serving landscape","REST APIs with plumber","Serving a tidymodels / vetiver model end to end","Throughput and latency","Multi-model serving and version routing","Serving runtimes and when to leave R","Serverless, edge and on-device inference"],"MLOps exercises","pipeline lab",'core'),
      S(6,true,"Containerization and deployment",'',["Docker for R","Multi-stage builds and slim, secure images","Configuration and secrets management","Deploying","Health checks, readiness and graceful shutdown"],"MLOps exercises","pipeline lab",'core'),
      S(7,true,"Testing and evaluation engineering",'',["Unit and integration testing for ML code (testthat)","Testing data","Testing models","Testing the serving layer","Evaluation sets and golden datasets","Regression testing for models","Slice-based and subgroup evaluation","Offline vs online evaluation, and eval-driven development"],"MLOps exercises","pipeline lab",'core'),
      S(8,true,"CI/CD/CT for ML",'',["CI for ML","Continuous delivery","Continuous training (CT)","Model approval gates and automated rollback","Infrastructure as code, an intro"],"MLOps exercises","pipeline lab",'core'),
      S(9,true,"Monitoring and drift - keeping a model healthy",'',["What to monitor","Data drift detection","Concept drift and silent performance decay","Alerts and thresholds without alert fatigue","Closing the loop"],"MLOps exercises","pipeline lab",'core'),
      S(10,false,"Observability and continual learning",'',["The three pillars","Distributed tracing across a prediction request","The prediction store and eval-in-production (shadow scoring, delayed-label backfill)","The full drift taxonomy","Multivariate and embedding drift","Retraining strategy","Online and incremental learning","Feedback loops and their dangers"],"MLOps exercises","pipeline lab",'adv'),
      ...
      S(12,false,"Deployment strategies and progressive delivery",'',["Shadow deployment","Canary and blue-green releases","Online A/B testing of models","Interleaving and multi-armed rollout","Progressive rollout, guardrail metrics and automated rollback","Multi-model serving, routing and champion/challenger"],"MLOps exercises","pipeline lab",'adv'),
      S(13,false,"Scaling and distributed ML",'',["Parallel R","Out-of-core and chunked processing","arrow and duckdb at warehouse scale","Distributed compute with Spark via sparklyr","Distributed and multi-GPU training","Autoscaling the serving layer"],"MLOps exercises","pipeline lab",'adv'),
      S(14,false,"Inference optimization, performance and cost",'',["The accuracy-latency-cost-throughput frontier","Quantization","Pruning, distillation and simpler-model substitution","Compilation and kernels","LLM-specific","Profiling R hot paths and the hot 5%","Latency budgets and caching","The economics of AI"],"MLOps exercises","pipeline lab",'adv'),
      S(15,false,"Reliability and SRE for ML",'',["SLOs, SLIs and error budgets for ML services","Graceful degradation and fallback models","Load, soak and chaos testing for ML","Incident response, on-call and blameless postmortems for ML","Capacity planning and the cost of reliability"],"MLOps exercises","pipeline lab",'adv'),
      S(16,false,"Security, privacy and governance",'',["Securing an ML/AI API","The ML attack surface","LLM security","Model and data supply chain","Privacy in production","Governance and compliance"],"MLOps exercises","pipeline lab",'adv'),
      S(17,false,"LLM serving and inference systems",'',["The LLM serving stack","Calling and routing LLMs from R with ellmer","Streaming responses (SSE) and token-level UX","Throughput","Model routing and fallback","Self-hosted vs API"],"MLOps exercises","pipeline lab",'ai'),
      S(18,false,"RAG and retrieval systems in production",'',["The RAG architecture","Chunking and the indexing pipeline","Embeddings and vector search","Hybrid search and re-ranking","Retrieval evaluation","Freshness, incremental indexing and cache invalidation","RAG observability and failure analysis"],"MLOps exercises","pipeline lab",'ai'),
      S(19,false,"Agentic systems in production",'',["From chains to agents","Agent architectures","Orchestration, state and memory","Agent observability and tracing","Evaluating agents","Cost and latency control for multi-call agents","Guardrails and human-in-the-loop for agents"],"MLOps exercises","pipeline lab",'ai'),
      S(20,false,"LLM and AI evaluation",'',["Why LLM eval is hard","Building eval sets and golden datasets for LLM tasks","LLM-as-judge","Reference-based and reference-free metrics","Human eval pipelines and inter-rater reliability","Online eval and regression suites in CI","Red-teaming and adversarial evaluation"],"MLOps exercises","pipeline lab",'ai'),
      S(21,false,"AI safety, guardrails and LLMOps",'',["Guardrails","Content safety, toxicity and PII redaction","Hallucination mitigation and grounding","Prompt management","Fine-tuning and adapter ops","Semantic caching and cost/latency control for LLM apps","Monitoring LLMs in prod"],"MLOps exercises","pipeline lab",'ai'),
      S(22,false,"ML and AI system design",'',["The system-design framework","Latency, scale and cost trade-offs","Case","Case","Case","Case","Case","The ML/AI system design interview"],"MLOps exercises","pipeline lab",'capstone')
    ]
  };
  ...
  var links = {
    ...
    'Tidy data principles':'/Importing-and-Tidy-Data-in-R.html',
    // Analyst S2 - join/reshape
    'Every join type, visualized':'/Joining-Tables-in-R.html',
    'Non-equi and rolling joins with join_by':'/Joining-Tables-in-R.html',
    // Analyst S5 - advanced ggplot2
    'Facets and small multiples':'/Facets-and-Scales-in-ggplot2.html',
    'Scales, guides and legends':'/Facets-and-Scales-in-ggplot2.html',
    'Custom themes and branding':'/Themes-Color-and-Accessibility.html',
    'Annotations that explain':'/Annotate-and-Compose-Plots.html',
    'Compose plots with patchwork':'/Annotate-and-Compose-Plots.html',
    'Label points with ggrepel':'/Annotate-and-Compose-Plots.html',
    // Analyst S6 - data.table  (interactive lessons; syntax/keys + dplyr-vs wired in the full pass)
    'data.table syntax in one lesson':'/data-table-Syntax-and-Keys.html',
    'Keys and lightning-fast joins':'/data-table-Syntax-and-Keys.html',
    'dplyr vs data.table, head to head':'/dplyr-vs-data-table.html',
    ...
    'Reports with Quarto and R Markdown':'/Reproducible-Reports-with-Quarto.html',
    'Parameterized, repeatable reports':'/Reproducible-Reports-with-Quarto.html',
    'Write the executive summary':'/Telling-a-Story-with-Data.html',
    'Tell a story with data':'/Telling-a-Story-with-Data.html',
    ...
    // DA interactive lessons (added)
    'Importing Data':'/Importing-and-Tidy-Data-in-R.html',
    'dplyr filter & select':'/The-dplyr-Verbs.html',
    'dplyr mutate and transmute':'/The-dplyr-Verbs.html',
    'dplyr group_by & summarise':'/Group-Summarise-and-Clean-in-dplyr.html',
    'arrange, distinct and count':'/Group-Summarise-and-Clean-in-dplyr.html',
    'Recode and derive with case_when':'/Group-Summarise-and-Clean-in-dplyr.html',
    'Missing Value Treatment':'/Missing-Value-Treatment.html',
    'R Joins':'/Joining-Tables-in-R.html',
    'pivot_longer & pivot_wider':'/Pivoting-Long-and-Wide-in-R.html',
    'Nest, unnest and rectangling':'/Nest-Unnest-and-Rectangling.html',
    'separate, unite and clean columns':'/Splitting-Uniting-and-Fuzzy-Joins.html',
    'Fuzzy matching and joins':'/Splitting-Uniting-and-Fuzzy-Joins.html',
    'EDA (7-Step Framework)':'/An-EDA-Framework-and-One-Variable.html',
    'Univariate EDA':'/An-EDA-Framework-and-One-Variable.html',
    'Bivariate EDA':'/Two-Variables-and-Correlation-in-R.html',
    'Correlation Analysis':'/Two-Variables-and-Correlation-in-R.html',
    'Outlier Detection':'/Outliers-and-Automated-EDA.html',
    'Automated EDA with skimr and DataExplorer':'/Outliers-and-Automated-EDA.html',
    'Grammar of Graphics':'/The-Grammar-of-Graphics.html',
    'ggplot2 Getting Started':'/The-Grammar-of-Graphics.html',
    'Scatter Plots':'/Scatter-and-Line-Charts-in-ggplot2.html',
    'Line Charts':'/Scatter-and-Line-Charts-in-ggplot2.html',
    'Bar Charts':'/Bar-and-Distribution-Charts-in-ggplot2.html',
    'Distribution Charts':'/Bar-and-Distribution-Charts-in-ggplot2.html',
    'Top 50 ggplot2 Visualizations':'/A-ggplot2-Gallery-and-Publication-Figures.html',
    'Publication-Ready Figures':'/A-ggplot2-Gallery-and-Publication-Figures.html',
    'Color scales and accessibility':'/Themes-Color-and-Accessibility.html',
    'Bridge the two with dtplyr':'/Bridge-with-dtplyr.html',
    'HTML tables with kableExtra':'/Report-Tables-with-gt-and-flextable.html',
    'Summarize and label data with an LLM (ellmer)':'/AI-Assisted-Analysis-in-R.html',
